...
<body class="bg-gray-100 text-gray-800 font-sans flex h-screen overflow-hidden">
    ...
    <option value="fermé">Fermé</option>
                            ...
                            <div class="relative w-full sm:w-40 ">
                                <select id="prioriteFilter" class="w-full bg-white border border-gray-200 rounded-xl px-2 py-3 text-gray-800 appearance-none focus:outline-none focus:ring-2 focus:ring-bleuciel">
    ...
    <script src="{{ asset('js/agentfilters.js') }}"></script>
</body>
</html>