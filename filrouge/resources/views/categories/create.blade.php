...
@section('content')
    <div class="p-6 flex-1 overflow-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-semibold">Ajouter une Nouvelle Catégorie</h1>
        ...
        <div class="bg-card rounded-lg p-6">
            <form action="{{ route('categories.store') }}" method="POST">
                ...
                <button type="submit" class="bg-blue-500 text-white py-2 px-4 rounded-md">Créer la Catégorie</button>
            </form>
        </div>
    </div>
@endsection
